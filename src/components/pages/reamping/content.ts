...
export const texts: Texts = {
  en: {
    head: 'Reamping',
    // description:
    //   'Reamping is a modern way of guitar signal processing, which allows bands to record guitars even at home and eventually gives a great result on a professional level.',
    title: 'Reamping',
    paragraph:
  ...
  ru: {
    head: 'Реампинг',
    // description:
    //   'Реампинг - это современный способ обработки гитарного сигнала, который позволяет группам записывать гитары даже в домашних условиях и в итоге дает отличный результат на профессиональном уровне.',
    title: 'Реампинг',
    paragraph:
